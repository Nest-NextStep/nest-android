...
fun PriorityComponent(
    defaultSortTask: Priority = priorities.first(),
...
fun PriorityItemComponent(
    ...
    Column(
        ...
        if (isSelected) {
            ...
            textColor = Color.Black // Change this to your desired color
        }
...
fun PriorityComponentPreview() {
    MaterialTheme {
        PriorityComponent(defaultSortTask = priorities.first(), onSelect = {})
    }
}